...
- interpolation grids for theory predictions (*grids* for short) in the form of
  `PineAPPL <https://github.com/N3PDF/pineappl/>`_ grids, together with
- Evolution Kernel Operators (**EKO**) generated by
  `eko <https://github.com/N3PDF/eko/>`_
...
You can reuse the EKOs from a different theory by running:: 
...
Then you can convolute the EKOs with the grids by running:: 
